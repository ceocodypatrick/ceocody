        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center mb-4">
              <Link href={`/artists/${track.artist.id}`} className="text-lg text-gray-700 hover:text-primary">
                {track.artist.name}
              </Link>
          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold">{formatNumber(track.stats?.plays || 0)}</div>
              </div>
              
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-sm text-gray-500 mb-1">Likes</div>
                <div className="text-2xl font-bold">{formatNumber(track.stats?.likes || 0)}</div>
              </div>
              
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-sm text-gray-500 mb-1">Saves</div>
                <div className="text-2xl font-bold">{formatNumber(track.stats?.saves || 0)}</div>
              </div>
            </div>
